...
class MySpiderSpider(scrapy.Spider):
    ...
    def _get_consulates(self, embassy_div):
        consulates_divs = []
        city = ""
    ...
    # def parse_mission_website(self, response, mission_item, consulate_items=None):
    #     try:
    #         person = response.css("div.story__image_margin h3::text").get()
    #         mission_item["head_of_mission"] = person
    #     except Exception as e:
    ...
    #         )
    #     finally:
    #         if consulate_items is not None:
    #             # Find and update the consulate item in the consulate_items list
    #             for idx, item in enumerate(consulate_items):
    #                 if item["website"] == mission_item["website"]:
    #                     consulate_items[idx] = mission_item
    #                     break
    #         yield mission_item
